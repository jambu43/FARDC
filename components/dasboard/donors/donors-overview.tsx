  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-4xl font-bold text-primary">{averageAmountDonations.toFixed(3)}$</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-4xl font-bold text-primary">{totalAmountCollected.toFixed(3)}$</div>
